 ...
 * @author fchmm
 */
public class Vistaaa extends javax.swing.JFrame {

    /**
     * Creates new form Vistaaa
     */
    public Vistaaa() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vistaaa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
